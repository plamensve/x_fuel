...
(() => {
    ...
    const initHero = () => {
        ...
        inner.innerHTML = `
            <div class="hero-v2-grid">
                <div class="hero-v2-visual" aria-hidden="true">
                    <img src="media/hero-woman-station.webp" alt="" class="hero-v2-model">
                    <div class="hero-v2-visual-fade"></div>
                </div>

                <div class="hero-v2-content">
                    <div class="hero-v2-brand">
                        <img src="media/2logo.png" alt="goriva.online" class="hero-v2-logo">
                    </div>
        ...
        style.textContent = `
            .about-project.hero-v2{position:relative;padding:28px 10px 34px!important;text-align:left!important;color:#0f2747;overflow:hidden}
            ...
            .hero-v2 .about-inner{max-width:1400px!important;margin:0 auto;position:relative;z-index:1}
            .hero-v2-grid{display:grid;grid-template-columns:minmax(320px,.82fr) minmax(0,1.65fr);gap:28px;align-items:stretch;min-height:610px}
            .hero-v2-visual{position:relative;min-height:610px;overflow:hidden;border-radius:42% 46% 42% 18%/30% 36% 28% 18%;background:#eaf4ff;box-shadow:inset 0 0 0 12px rgba(225,238,255,.85)}
            .hero-v2-model{width:100%;height:100%;object-fit:cover;object-position:42% center;display:block;transform:scale(1.045)}
            .hero-v2-visual::after{content:"";position:absolute;inset:0;border-radius:inherit;border:10px solid rgba(219,234,254,.75);pointer-events:none}
            .hero-v2-visual-fade{position:absolute;inset:0;background:linear-gradient(90deg,transparent 0 78%,rgba(255,255,255,.96) 96%,#fff 100%);pointer-events:none}
            .hero-v2-content{min-width:0;padding:8px 0 0;display:flex;flex-direction:column;align-items:center;text-align:center}
            .hero-v2-brand{display:flex;justify-content:center;margin:0 0 8px}
            .hero-v2-logo{width:230px;max-height:74px;object-fit:contain;display:block}
            ...
            .hero-v2-title{margin:0;color:#0f2747;font-size:clamp(44px,5vw,72px);line-height:.98;font-weight:900;letter-spacing:-.045em;background:linear-gradient(90deg,#2468e8 4%,#087db1 50%,#0f9c5d 100%);-webkit-background-clip:text;background-clip:text;color:transparent;position:relative}
            .hero-v2-title::after{content:"";position:absolute;width:145px;height:7px;border-radius:999px;background:#f6b61c;right:4%;top:31%;transform:rotate(-2deg)}
            ...
            .hero-v2-card{min-width:0;display:grid;grid-template-columns:50px 1fr;gap:12px;align-items:center;padding:18px 16px;background:rgba(255,255,255,.94);border:1px solid #e7edf5;border-radius:18px;box-shadow:0 12px 30px rgba(15,39,71,.08);text-align:left}
            ...
            @media(max-width:1100px){.hero-v2-grid{grid-template-columns:minmax(270px,.72fr) minmax(0,1.45fr);min-height:560px}.hero-v2-visual{min-height:560px}.hero-v2-title{font-size:clamp(40px,5vw,58px)}.hero-v2-card{grid-template-columns:44px 1fr;padding:15px 13px}.hero-v2-icon{width:44px;height:44px}.hero-v2-instagram{grid-template-columns:58px 1fr auto;padding:18px 20px}.hero-v2-instagram-icon{width:54px;height:54px;font-size:35px}.hero-v2-instagram-btn{min-width:145px}}
            @media(max-width:840px){.about-project.hero-v2{padding:18px 8px 28px!important}.hero-v2-grid{grid-template-columns:1fr;gap:16px;min-height:0}.hero-v2-visual{order:2;min-height:330px;max-height:420px;border-radius:30px}.hero-v2-visual-fade{background:linear-gradient(0deg,#fff 0%,rgba(255,255,255,.15) 28%,transparent 58%)}.hero-v2-content{order:1}.hero-v2-logo{width:200px}.hero-v2-title{font-size:clamp(40px,10vw,58px)}.hero-v2-desc br{display:none}.hero-v2-features{grid-template-columns:1fr}.hero-v2-card{padding:15px 16px}.hero-v2-instagram{grid-template-columns:58px 1fr;margin-top:18px}.hero-v2-instagram-btn{grid-column:1/-1;width:100%;box-sizing:border-box}.hero-v2-badge{font-size:10.5px;padding:8px 13px}.hero-v2-visual{display:none}}
            @media(max-width:520px){.hero-v2-title{font-size:42px;line-height:1}.hero-v2-title::after{width:92px;height:5px;right:2%;top:32%}.hero-v2-desc{font-size:15px;margin:20px 0}.hero-v2-brand{margin-top:2px}.hero-v2-logo{width:180px}.hero-v2-card strong{font-size:14px}.hero-v2-card span{font-size:12px}.hero-v2-instagram{padding:18px 16px;gap:12px;border-radius:20px}.hero-v2-instagram-copy strong{font-size:15px}.hero-v2-instagram-copy span{font-size:12px}.hero-v2-instagram-icon{width:50px;height:50px}.hero-v2-badge{white-space:normal;text-align:center;justify-content:center}}
        `;
