...
function getStationLogo(name) {
    ...
    if (lower.includes("omv") || lower.includes("омв")) return "../images/station_logos/omv-logo.jpg"
    if (lower.includes("shell") || lower.includes("шел")) return "../images/station_logos/shell-logo.png"
    if (lower.includes("rompetrol") || lower.includes("ромпетрол")) return "../images/station_logos/rompetrol-logo.png"
    if (lower.includes("insa") || lower.includes("инса")) return "../images/station_logos/insa-card-logo.png"
    if (lower.includes("kruiz") || lower.includes("круиз")) return "../images/station_logos/kruiz-logo.png"
    ...
    if (lower.includes("himoil") || lower.includes("химойл")) return "../images/station_logos/himoil-logo.png"
