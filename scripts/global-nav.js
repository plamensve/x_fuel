(() => {
    ...
    function ensureStyles() {
        ...
        return new Promise(resolve => {
            ...
            link.rel = "stylesheet";
            link.href = "/pages/styles/global-progress.css?v=20260909-insa1";
            const finish = () => resolve();
