(() => {
    ...
    function ensureStyles() {
        ...
        return new Promise(resolve => {
            ...
            link.rel = "stylesheet";
            link.href = "/pages/styles/global-progress.css?v=20260907-cars1";
            const finish = () => resolve();
