...
(() => {
    ...
    gorivaLoadScript("/scripts/global-nav.js?v=20260911-privacy-banner1", { id: "goriva-global-nav-script" })
...
(() => {
    ...
    const src = "/scripts/home-hero-map-pro.js?v=20260911-hero-controls-centered-v2";
